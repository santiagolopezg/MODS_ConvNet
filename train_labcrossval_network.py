...
for i in xrange(n_dataset):
	for name in ['train_1', 'train_2', 'train_3']:
	    ...
	    checkpoint = ModelCheckpoint('best_weights_labcrossval_{0}_{1}_{2}.h5'.format(i, name, username), monitor='val_acc', verbose=1, save_best_only=True, mode='max')
		...
		plt.xlabel('epoch')
		plt.savefig('acc_dset_{0}_{1}_{2}'.format(i, name, usernams))
		plt.clf()
