...
for i in xrange(n_dataset):
    ...
    try:
	weights='best_weights_labcrossval_3_{1}_{2}.h5'.format(i, name, username)
    ...
    reduce_lr = keras.callbacks.ReduceLROnPlateau(monitor='val_acc', factor=0.5, patience = 5, verbose=1, min_lr=1e-10)
    ...
    fpath = 'best_weights_v2_labcrossval_{0}_{1}_{2}.h5'.format(i, name, username)
