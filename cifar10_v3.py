...
cifar v1 clone, but shallower - trying to get faster training with approx same perf
...
model.add(Convolution2D(256, 6, 6,init=weight_init, name='conv2_1'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))  
model.add(Dropout(dropout))
...
model.add(Convolution2D(1024, 2, 2,init=weight_init, name='conv4_1'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))  
model.add(Dropout(dropout))
