# -*- coding: utf-8 -*-
'''
An attempt to educate the Functional API hipster implementation of cifar10.
'''
...
for i in xrange(n_dataset):
    ...
    name = 'MODS_keras_big_hipster_weights_{0}_{1}_{2}_{3}_{4}.h5'.format(i, dropout, optimizer, batch_size,username)
